...
pheatmap(
  ...
  annotation_col = annotation_col_group,  # Add Group, Death, and Gender annotations
...
# Create heatmap
# Convert to numeric matrix for heatmap, preserve patient id as row names
data_matrix <- as.matrix(new_normalized_data[,-c(1, (ncol(new_normalized_data)-2):ncol(new_normalized_data))]) # Exclude patient id and group
