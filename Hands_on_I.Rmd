...
data_frame$ca <- as.integer(data_frame$ca) 
data_frame$thal <- as.integer(data_frame$thal)
...
outlier(data_frame$trestbps)    # returns 200
outlier(data_frame$chol)        # returns 564
outlier(data_frame$age)         # returns 29
outlier(data_frame$thalach)     # returns 71
outlier(data_frame$oldpeak)     # returns 6.2
outlier(data_frame$thal)        # returns 7

# Count how many rows outliers we have in each case
# na.rm = TRUE ignores NA values
sum(data_frame$trestbps == 200, na.rm = TRUE)    # returns 1
sum(data_frame$chol == 564, na.rm = TRUE)        # returns 1
sum(data_frame$age == 29, na.rm = TRUE)          # returns 1
sum(data_frame$thalach == 71, na.rm = TRUE)      # returns 1 
sum(data_frame$oldpeak == 6.2, na.rm = TRUE)     # returns 1
sum(data_frame$thal == 7, na.rm = TRUE)          # returns 115
