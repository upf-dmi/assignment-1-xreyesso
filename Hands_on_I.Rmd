...
library(outliers)
## 1- Read the table
d <- read.table("/home/wael-badr/Desktop/UPF/2nd_trimester/DMI/assignment-1-xreyesso/data/heart_disease_dataset.csv", header=T, sep="\t")

# Load the raw data
file_path <- "/home/wael-badr/Desktop/UPF/2nd_trimester/DMI/assignment-1-xreyesso/data/heart_disease_dataset.csv"
...
#correlation matrix with the numeric measurments 
...
table <- read_excel("/home/wael-badr/Downloads/Table_1.XLSX") 
